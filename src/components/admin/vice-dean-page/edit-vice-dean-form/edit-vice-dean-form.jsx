...
import { updateViceDean } from "../../../../api/api";

const EditViceDeanForm = () => {
    ...
    return (
        <Container className="new-vice-dean-form-container">
            <Card>
                <Card.Body>
                    <Card.Title>Update Vice Dean</Card.Title>
                    <Card.Text
                        style={{ fontSize: "12px" }}
...
export default EditViceDeanForm;
